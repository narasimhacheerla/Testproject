...
namespace LinkedIn
{
  ...
  public class LinkedInService
  {
    ...
    public LinkedInService(string consumerkey, string consumersecret, string accesstoken, string tokensecret)
    {
    ...
    private Person GetProfile(UriBuilder location, List<ProfileField> profileFields)
    {
      ...
      {
        var peopleFieldSelectorConverter = new PeopleFieldSelectorConverter(true);
    ...
    {
      return GetConnectionsForCurrentUser(new List<ProfileField>(), -1, -1, Modified.All, 1);
    }
