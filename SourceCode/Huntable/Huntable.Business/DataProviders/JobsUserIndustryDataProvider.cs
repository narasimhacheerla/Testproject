...
{
    public class JobsUserIndustryDataProvider : DataProviderBase
    {
        public override IList<dynamic> GetItems(huntableEntities context, string searchContains, string startsWith, int pageIndex, int pageSize)
        {
            ...
            List<PreferredJobUserIndustry> selectedIndustries = context.PreferredJobUserIndustries.ToList();
        ...
        public override void UpdateItems(List<int> newlyCheckedList, List<int> newlyUncheckedList)
        {
            using (var context = huntableEntities.GetEntitiesWithNoLock())
            {
                ...
                {
                    context.AddToPreferredJobUserIndustries(new PreferredJobUserIndustry { UserId = UserId, MasterIndustryId = newlyCheckedItem });
                }

                List<PreferredJobUserIndustry> allUserIndustries = context.PreferredJobUserIndustries.ToList();
