...
namespace OAuthUtility
{
    public static class OAuthWebSecurity
    {
        ...
        public static void ShareOnFacebook(string token,string message,string pictureUrl)
        {
            if (pictureUrl != "")
            {
                FacebookOAuth2Client.ImageShare(token, message, pictureUrl);
            }
            else
            {
                FacebookOAuth2Client.StatusShare(token, message);
            }
        }


        public static void ShareVideoOnFacebook(string token, string message, string videoUrl)
        {
            FacebookOAuth2Client.VideoShare(token,  message,videoUrl);
        }


        public static void ShareLinkOnFacebook(string accesstoken, string name, string message, string description, string caption, string url, string imageUrl)
        {
            FacebookOAuth2Client.LinkShare( accesstoken,  name,  message,  description,  caption,  url,  imageUrl);
        }

        public static void PostTweet(string token, string secret, string message)
        {
            TwitterOAuthClient.PostTweet(token,secret,message);
        }
        ...
        {
            RegisterClient(new FacebookOAuth2Client(appId, appSecret), displayName, extraData);
        }
        ...
        {
            var twitterClient = new TwitterOAuthClient(consumerKey, consumerSecret);
        ...
        {
            var linkedInClient = new LinkedInOAuthClient(consumerKey, consumerSecret);
        ...
        /// </summary>
        public static void RegisterGoogleClient(string consumerKey, string consumerSecret)
        {
            RegisterGoogleClient(consumerKey, consumerSecret, displayName: "Google");
        }
        ...
        /// </summary>
        /// <param name="displayName">The display name.</param>
        public static void RegisterGoogleClient(string consumerKey, string consumerSecret, string displayName)
        {
            var googleclient = new GoogleOAuth2Client(consumerKey, consumerSecret);
            RegisterClient(googleclient, displayName, new Dictionary<string, object>());
        }
        ...
        public static void RegisterGoogleClient(string consumerKey, string consumerSecret, string displayName, IDictionary<string, object> extraData)
        {
            var googleclient = new GoogleOAuth2Client(consumerKey, consumerSecret);
            RegisterClient(googleclient, displayName, extraData);
        }

        /// <summary>
        /// Registers the Yahoo client.
        /// </summary>
        public static void RegisterYahooClient(string consumerKey, string consumerSecret)
        {
            RegisterYahooClient(consumerKey,consumerSecret, displayName: "Yahoo");
        }
        ...
        /// </summary>
        /// <param name="displayName">The display name.</param>
        public static void RegisterYahooClient(string consumerKey, string consumerSecret, string displayName)
        {
            var yahooclient = new YahooOAuthClient(consumerKey, consumerSecret);
            RegisterClient(yahooclient, displayName, new Dictionary<string, object>());
        }
        ...
        /// <param name="displayName">The display name.</param>
        /// <param name="extraData">The data bag.</param>
        public static void RegisterYahooClient(string consumerKey, string consumerSecret, string displayName, IDictionary<string, object> extraData)
        {
            var yahooclient = new YahooOAuthClient(consumerKey, consumerSecret);
            RegisterClient(yahooclient, displayName, extraData);
        }
        ...
        public static IAuthenticationClient GetOAuthClient(string providerName)
        {
