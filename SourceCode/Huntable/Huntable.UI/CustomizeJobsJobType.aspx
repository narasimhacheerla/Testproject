<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="~/CustomizeJobsJobType.aspx.cs" Inherits="Huntable.UI.CustomizeJobsJobType" %>
        ...
        <div id="content-inner">
            ...
            <div class="content-inner-left">
                ...
                <div id="st_horizontal" class="st_horizontal">
                        ...
                        <div style="overflow: visible;" class="st_slide_container">
                            <ul style="margin-left: 0px;" class="st_tabs">
                               <li><a  href="javascript:callnextbutton('customizejobssalary.aspx');" class="st_tab1">Salary</a></li>
                                ...
                                <li><a   href="javascript:callnextbutton('customizejobsjobtype.aspx');" class="st_tab1 st_first_tab st_tab_active">Job type</a></li>
                  ...
                  <uc:atoz runat="server" ID="ucAtoZFeedsJobType" SearchTitle = "Search by Job Type:"/>              
            </div>
