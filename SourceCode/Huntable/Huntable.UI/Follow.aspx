<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Follow.aspx.cs" Inherits="Huntable.UI.Follow" %>
            ...
            <div id="tabsAndContent">
                <ul id="tabsNav1">
                    ...
                    <li><a href="#customize-feeds" class="tab-ash1">
                        ...
                        Feeds and jobs</a></li>
                    <li class="active"><a href="#follow" class="tab-ash1">
