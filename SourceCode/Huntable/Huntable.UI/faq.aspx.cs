...
namespace Huntable.UI
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            LoggingManager.Debug("Entering Page_Load -  WebForm1.aspx");


            LoggingManager.Debug("Exiting Page_Load -  WebForm1.aspx");
        }

        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering btnSendMail_Click -  WebForm1.aspx");
            ...
            LoggingManager.Debug("Exiting btnSendMail_Click -  WebForm1.aspx");
        ...
        {
            LoggingManager.Debug("Entering lnkRP_Click -  WebForm1.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "Report a Problem";
            LoggingManager.Debug("Exiting lnkRP_Click -  WebForm1.aspx");

        }
        protected void lnkQ_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkQ_Click -  WebForm1.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "User has a Question";

            LoggingManager.Debug("Exiting lnkQ_Click -  WebForm1.aspx");
        }
        protected void lnkSugg_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkSugg_Click -  WebForm1.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "User sent a Suggestion";
            LoggingManager.Debug("Exiting lnkSugg_Click -  WebForm1.aspx");

        }
        protected void lnkApp_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkApp_Click -  WebForm1.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "Appreciated";
            LoggingManager.Debug("Exiting lnkApp_Click -  WebForm1.aspx");
        }
        protected void lnkAny_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkAny_Click -  WebForm1.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "User Comments";
            LoggingManager.Debug("Exiting lnkAny_Click -  WebForm1.aspx");
        }

        protected void btnSend_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering btnSend_Click -  WebForm1.aspx");
            ...
            LoggingManager.Debug("Exiting btnSend_Click -  WebForm1.aspx");
        }
    }
}