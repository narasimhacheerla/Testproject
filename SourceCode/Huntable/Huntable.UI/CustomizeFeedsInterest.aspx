<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="~/CustomizeFeedsInterest.aspx.cs" Inherits="Huntable.UI.CustomizeFeedsInterest" %>
        ...
        <div id="content-inner">
            ...
            <div class="content-inner-left">
                ...
                <ul class="tab-list tab-list-search">
                    ...
                    <li><a  href="javascript:callnextbutton('CustomizeFeedsInterest.aspx');" class="st_tab st_first_tab st_tab_active">Interest</a></li>
                    <li><a  href="javascript:callnextbutton('CustomizeFeedscountry.aspx');" class="st_tab">Country</a></li>
                </ul>
                <uc:atoz runat="server" ID="ucAtoZFeedsInterest" SearchTitle = "Search by Interest:" GroupItemCount = "1" />              
            </div>
