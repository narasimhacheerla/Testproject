...
namespace Huntable.UI
{
    public partial class ContactUs : System.Web.UI.Page
    {
        ...
        {
            LoggingManager.Debug("Entering Page_Load - ContactUs .aspx");


            LoggingManager.Debug("Exiting Page_Load - ContactUs .aspx");
        }

        protected void btnSendMail_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering btnSendMail_Click - ContactUs .aspx");
            ...
            LoggingManager.Debug("Exiting btnSendMail_Click - ContactUs .aspx");
        ...
        {
            LoggingManager.Debug("Entering lnkRP_Click - ContactUs.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "Report a Problem";
            LoggingManager.Debug("Exiting lnkRP_Click - ContactUs.aspx");

        }
        protected void lnkQ_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkQ_Click - ContactUs.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "User has a Question";

            LoggingManager.Debug("Exiting lnkQ_Click - ContactUs.aspx");
        }
        protected void lnkSugg_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkSugg_Click - ContactUs.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "User sent a Suggestion";
            LoggingManager.Debug("Exiting lnkSugg_Click - ContactUs.aspx");

        }
        protected void lnkApp_Click(object sender, EventArgs e)
        {
            LoggingManager.Debug("Entering lnkApp_Click - ContactUs.aspx");
            txtSubject.Text = "";
            txtSubject.Text = "Appreciated";
            LoggingManager.Debug("Exiting lnkApp_Click - ContactUs.aspx");
        }
        ...
        {
            LoggingManager.Debug("Entering btnSend_Click - ContactUs.aspx");
            ...
            LoggingManager.Debug("Exiting btnSend_Click - ContactUs.aspx");
        }
    }
}