<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CompaniesIndustry.aspx.cs" Inherits="Huntable.UI.CompaniesIndustry" %>
                            ...
                            <div class="st_tabs_container st_sliding_active">
                                <div style="overflow: hidden; margin: 0px 0px 20px 0px;" class="st_slide_container">
                                    <ul style="margin-left: 0px;" class="st_tabs">
                                        <li><a href="CompaniesIndustry.aspx" class="st_tab st_first_tab st_tab_active">Industry</a></li>
                                                        ...
                                                        <asp:Repeater runat="server" ID="rspCountry">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblCountry" CssClass=" checkbox-desc">
                                                                    <asp:CheckBox runat="server" CssClass=" checkbox-tab" InternalId='<%#(Eval("Id")) %>'
                                                                        ID="chbcountry" /><%#(Eval("Description")) %></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:Repeater>
