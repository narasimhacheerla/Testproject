<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CompaniesJobs.aspx.cs" Inherits="Huntable.UI.CompaniesJobs" %>
...
<![endif]-->
     ...
     <div  style="margin-left: 621px;;margin-top:-13px"><image id="ximg"  src="images/orange-check-mark-md.png" width="10px" height="10px"></image></div></div> </div>
                            ...
                            <div class="st_tabs_container st_sliding_active">
                                <div style="overflow: hidden; margin: 0px 0px 20px 0px;" class="st_slide_container">
                                    <ul style="margin-left: 0px;" class="st_tabs">
                                        ...
                                        <li><a href="companiesjobs.aspx" class="st_tab st_first_tab st_tab_active">Jobs Available</a></li>
                                    ...
                                    <div class="notification-left-top">
                                        <div class="notification-left notification-left-tab ">
                                            <div class="tab-form">
                                                ...
                                                <asp:Repeater runat="server" ID="rspJobs">
                                                    <ItemTemplate>
                                                        <asp:CheckBox runat="server" CssClass=" checkbox-tab" ID="chbjobs" Text='<%#(Eval("NoofEmployess")) %>' />Jobs<br />
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </div>
                                        </div>
        ...
        <div class="content-inner-right" style="margin-top: 21px;">
