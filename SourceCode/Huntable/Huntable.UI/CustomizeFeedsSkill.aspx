<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomizeFeedsSkill.aspx.cs" Inherits="Huntable.UI.CustomizeFeedsSkill" %>
        ...
        <div id="content-inner">
            ...
            <div class="content-inner-left">
                <ul class="customize-feed">
                    ...
                    <li runat="server" id="jobuser"><a href="CustomizeJobssalary.aspx" runat="server" >Customize Jobs</a></li>
                </ul>
               <ul class="tab-list tab-list-search">
                    ...
                    <li><a href="javascript:callnextbutton('CustomizeFeedsSkill.aspx');" class="st_tab st_first_tab st_tab_active">Skill</a></li>
                    <li><a href="javascript:callnextbutton('CustomizeFeedsInterest.aspx');" >Interest</a></li>
