<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomizeJobsInterest.aspx.cs" Inherits="Huntable.UI.CustomizeJobsInterest" %>
                        ...
                        <div style="overflow: visible;" class="st_slide_container">
                            <ul style="margin-left: 0px;" class="st_tabs">
                               ...
                               <%-- <li><a href="CustomizeJobsCompany.aspx" class="st_tab">Company</a></li>
                                <li><a href="CustomizeJobsInterest.aspx" class="st_tab st_first_tab st_tab_active">Interest</a></li>--%>
