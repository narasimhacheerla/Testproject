...
<head id="Head1" runat="server">
    <title>HuntableChat Messenger</title>
...
<body data-messengermode="true">
    ...
    <script src='<%= ResolveUrl("~/App_Themes/"+Theme+"/layout.js") %>' type="text/javascript"></script>
        <span id="templates" data-url='<% = Page.ResolveUrl("~/App_Themes/"+Theme+"/templates.html") %>' style="display: none">
        </span>
        <bgsound id="sound" />
        ...
        <div id="container">
            ...
            <div id="aside_messenger">
                    ...
                    <div id="divCurrentUserVideo" class="video_second"></div>
                </div>
            </div>
            <div id="footer">
