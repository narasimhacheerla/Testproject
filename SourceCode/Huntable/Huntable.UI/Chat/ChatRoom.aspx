...
<%@ Import Namespace="eStreamChat" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>eStreamChat</title>
    <link href="<%# ResolveUrl("~/Chat/Styles/Style.css") %>" rel="stylesheet" type="text/css" />
    <link href="<%# ResolveUrl("~/Chat/Styles/jquery.contextMenu.css") %>" rel="stylesheet" type="text/css" />
     <script src="http://code.jquery.com/jquery-1.6.min.js" type="text/javascript"></script>
    <script src="http://code.jquery.com/ui/1.8.23/jquery-ui.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.jqote2.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.blink.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.colorPicker.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.emoticon.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.ajaxfileupload.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/jquery.contextMenu.mod.js") %>"></script>
    <script type="text/javascript" src="<%# ResolveUrl("~/Chat/Scripts/eStreamChat.js") %>"></script>
    <script src='<%# ResolveUrl("~/App_Themes/"+Theme+"/layout.js") %>' type="text/javascript"></script>
</head>
<body>
    <span id="templates" data-url='<% = Page.ResolveUrl("~/App_Themes/"+Theme+"/templates.html") %>' style="display:none"></span>
    <bgsound id="sound" />
    ...
    <div id="container">
        ...
        <div id="footer">
            ...
            <span class="color_picker_wrap"><input id="textColor" type="text" value="#000000" /></span>
                ...
                <a class="poweredby" href="http://huntable.co.uk" target="_blank"></a>
            </div>
            <div class="send_msg">
