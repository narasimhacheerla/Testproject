<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" EnableViewState="true" AutoEventWireup="true"
    CodeBehind="AddPictures.aspx.cs" Inherits="Huntable.UI.AddPictures" %>
...
<body>
   ...
   <label > Add Description for your picture</label><asp:TextBox ID="txd"  runat="server"></asp:TextBox>
  ...
  <asp:Image runat="server" ImageUrl=' <%# "~/LoadFile.ashx?id=" + Container.DataItem%>' Width="150px" Height="160px" />
  </li>
  </ItemTemplate>
  </asp:Repeater>
  </ul>
