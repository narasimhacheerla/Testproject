<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FindYourDreamJob.aspx.cs" Inherits="Huntable.UI.FindYourDreamJob" %>
            ...
            <div id="tabsAndContent">
                <ul id="tabsNav1">
                    ...
                    <li><a href="#head-hunted" class="tab-ash1">
                        ...
                        headhunted</a></li>
                    <li class="active"><a href="#find-job" class="tab-ash1">
