<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CompaniesCountry.aspx.cs" Inherits="Huntable.UI.CompaniesCountry" %>
                            ...
                            <div class="st_tabs_container st_sliding_active">
                                <div style="overflow: hidden; margin: 0px 0px 20px 0px;" class="st_slide_container">
                                    <ul style="margin-left: 0px;" class="st_tabs">
                                        ...
                                        <li><a href="CompaniesCountry.aspx" class="st_tab st_first_tab st_tab_active">Country</a></li>
                            ...
                            <div class="text">
                                <div class="alphabet-list">
                                    <div class="notification-left-top">
                                        <div class="notification-left notification-left-tab" style="height: 560px; overflow-y: scroll;
                                            overflow-x: hidden;">
                                            <div class="tab-form">
                                                ...
                                                <asp:Repeater runat="server" ID="rspCountry">
                                                    <ItemTemplate>
                                                        <asp:CheckBox runat="server" CssClass="checkbox-tab" ID="chbcountry" Text='<%#(Eval("Description")) %>' />
                                                        <br />
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                                <%--<asp:LinkButton runat="server" ID="lnkshow" Text="search" OnClick="Showmore"></asp:LinkButton>--%>
                                            </div>
                                        </div>
                                                ...
                                                <ItemTemplate>
                                                    <div style="border-bottom: 1px dotted #0A0A0A; width: 384px; height: 142px;">
                                                        <div class="company-left">
                                                                ...
                                                                <asp:Image runat="server" alt="Feaured-logo" Width="128px" Height="74px" ImageUrl='<%#Eval("CompanyImagePath")%>' /></a>
                                                        ...
                                                        <div class="company-right">
                                                            <a  href='<%#UrlGenerator(Eval("Id")) %>' id="A1" runat="server">
                                                                <asp:Label runat="server" Text='<%#Eval("CompanyName")%>'></asp:Label></a><br />
                                                            <strong>
