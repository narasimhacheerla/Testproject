<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Super-power.aspx.cs" Inherits="Huntable.UI.Super_power" %>
    ...
    <div id="content-section">
        <div id="content-inner">
            <div id="tabsAndContent">
                <ul id="tabsNav1">
                    <li class="active"><a href="#super-power" class="tab-ash1">
                    ...
                    <li><a href="#connect-and-network" class="tab-ash1">
                        ...
                        and Network</a></li>
                    <li><a href="#head-hunted" class="tab-ash1">
                ...
                <ul id="tabContent">
                    <li id="super-power">
                        ...
                        <div class="upgrade register-font">
                            <strong class="floatleft"><a href="Default.aspx" class="accounts-link register-link">
                                Register Now</a> and its totally <strong class="red-color">Free !!!</strong></strong>
                            <a style="margin-left: 20px;" class="button-green button-green-register" href="Default.aspx">
                                Sign up</a>
                        </div>
                    </li>
                    <li id="customize-feeds">
                        ...
                        <div class="upgrade register-font">
                            <strong class="floatleft"><a href="Default.aspx" class="accounts-link register-link">
                                Register Now</a> and its totally <strong class="red-color">Free !!!</strong></strong>
                            <a class="button-green button-green-register" href="Default.aspx">Sign up</a>
                        </div>
                    </li>
                    <li id="follow">
                        <div class="welcome-tab" style="border-bottom: 1px dotted #CCCCCC; padding-bottom: 10px;">
