<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConnectAndNetwork.aspx.cs" Inherits="Huntable.UI.ConnectAndNetwork" %>
        ...
        <div id="content-inner">
            <div id="tabsAndContent">
                <ul id="tabsNav1">
                    ...
                    <li class="active"><a href="#connect-and-network" class="tab-ash1">
