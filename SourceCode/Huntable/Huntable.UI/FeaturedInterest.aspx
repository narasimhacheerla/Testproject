<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FeaturedInterest.aspx.cs" Inherits="Huntable.UI.FeaturedInterest" %>
...
<script type="text/javascript">
    $(function () {
        ...
        if (!msie6) {
            var top = $('#bx3').offset().top;
            $(window).scroll(function (event) {
                var y = $(this).scrollTop();
                if (y >= 310) { $('#bx3').addClass('fixed'); }
                else { $('#bx3').removeClass('fixed'); }
            });
        }
    });</script>
...
<div id="content-section">
    	<div id="content-inner">
        	...
        	<div class="green-desc">
            	Feature your company and logo here. Choose your target audience. Each selection is only $<asp:Label ID="lblFeaturedCategoryPrice" runat="server" Text="10" Visible="true"></asp:Label>
            </div>
           ...
           <ul class="tab-list tab-list-search">
                    ...
                    <li><a href="featuredinterest.aspx" class="st_tab st_first_tab st_tab_active">Interest</a></li>
         ...
         <%--    <h3>Alphabetical List</h3>
             ...
             <div id="interest">
            <asp:DataList ID="dlInterest" runat="server" RepeatColumns="2">
                <ItemTemplate>
                    <table>
                        <tr>
                            <td>
            ...
            <asp:Button ID="btnCheckOut" class="button-orange" Style="float: left; margin-left: 100px;" runat="server" Text="Continue" OnClick="BtnCheckOutClick" />       
             ...
             <div class="total-reach">
              ...
              Industries:<asp:Label ID="lblIndustries" runat="server" Text="" Visible="true"></asp:Label><br/>
            	...
            	Total Reach:
                <strong><label runat="server" id="lblTotalReach">0</label></strong>&nbsp;&nbsp;
                Total Cost:
                <strong>$<asp:Label ID="lblTotalCost" runat="server" Text="" Visible="true"></asp:Label></strong>
                </div>
              <%--  <a href="#" class="button-orange" style="float:left; margin-left:100px;">Continue</a>--%>
               <asp:Button ID="btnInterest" class="button-orange" style="float: left; margin-left: 100px;" runat="server" Text="Check Out" OnClick="BtnInterestClick" />  
            </div>  
            <p class="margin-top-visible">&nbsp;</p>   
            <div id="bx3"><uc1:FeaturedRecruiters ID="featuredRec" runat="server" /></div>                       
           <%--<div><h3 class="featured-head" style="float:left;">Featured Recruiters</h3><a href="#" class="accounts-link get-feature">Get Featured Here</a></div>
<div class="box-right" >
                <div class="head-ash">
               	  <h3>10,235 Recruiters Including</h3>
                  </div>
               
                  
                 <ul class="how-it-work-list how-it-work-list1">
                 	<li><a href="#"><img src="images/featured-logo1.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                    <li><a href="#"><img src="images/featured-logo2.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                    <li><a href="#"><img src="images/featured-logo2.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                    <li><a href="#"><img src="images/featured-logo1.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                    <li><a href="#"><img src="images/featured-logo1.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                    <li><a href="#"><img src="images/featured-logo2.jpg" width="124" height="70" alt="Feaured-logo" />(0) Jobs</a></li>
                 ...
                 <a href="#" class="learn-more">See More Recruiters</a>
              </div>--%>  
