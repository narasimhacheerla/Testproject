...
{
    public partial class InfosysEmployees_3_ : System.Web.UI.UserControl
    {
              ...
              if (compId.HasValue)
                {
                    ...
                    using (var context = huntableEntities.GetEntitiesWithNoLock())
                    {
                        try
                        {
                            ...
                            dl.DataSource = emplyuser.Distinct().Take(3);
                            dl.DataBind();
                        }
                        catch (Exception ex)
                        {
            ...
            try
            {
                ...
                if (btnCompanyEmployeeFollow != null)
                {
                    ...
                    if (loginUserId != null)
                    {
                        ...
                        ScriptManager.RegisterClientScriptBlock(this.Page, typeof(UpdatePanel), "Call my function", "overlay('Succesfully Unfollowed')", true);
                    }
            ...
            try
            {
                ...
                //{
                    if (loginUserId != null)
                    {
                       ...
                       ScriptManager.RegisterClientScriptBlock(this.Page , typeof(UpdatePanel), "Call my function", "overlay('You are now following')", true);
                    }
                }
            //}
            catch (Exception)
