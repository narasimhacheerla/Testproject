<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InfosysEmployees.ascx.cs"
    Inherits="Huntable.UI.UserControls.InfosysEmployees" %>
...
<div class="box-right box-right-company" style="overflow-y:scroll;overflow-x:hidden;height:364px;width:231px">
   <asp:UpdatePanel ID="Update_Panel" runat="server">
    ...
    <asp:DataList runat="server" ID="dl">
        <ItemTemplate>
            <div class="want-to-follow-list" style="width: 180px;">
                <div class="want-to-follow-list-left">
                    <a href='<%#UrlGenerator(Eval("Id")) %>'>
                        <asp:Image class="profile-pic profile-pic2" runat="server" ImageUrl='<%#Picture(Eval("PersonalLogoFileStoreId")) %>'
                            Height="40" Width="40" />
                    </a>
                </div>
                <div class="want-to-follow-list-middle" style="width: 115px;">
                    <strong><a href='<%#UrlGenerator(Eval("Id")) %>' class="accounts-link">
                        <asp:Label runat="server" Text='<%#Eval("FirstName") %>'></asp:Label>
                    </a></strong>
                    <p>
                        <asp:Label ID="Label1" runat="server" Text='<%#Eval("JobTitle") %>'></asp:Label></p>
                </div>
                <div class="want-to-follow-list-right">
                    <div id="DivFollowing" runat="server" visible='<%#IsThisUserFollowingCompany(Eval("Id"))%>'>
                        <asp:LinkButton ID="linkButtonFollowing" Text="Following" CommandArgument='<%#Eval("Id")%>'
                            ...
                            runat="server" Style="padding: 5px 7px; width: 51px; float: left;" class="invite-friend-btn"></asp:LinkButton>
                    </div>
        ...
        <asp:Button runat="server" ID="btn_more" Text=">see more" OnClick="click_seemore" style="margin-left: 134px; color: #008CA1; border: #D5E2E2;" />                     
