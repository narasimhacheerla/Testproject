<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomizeJobsIndustry.aspx.cs" Inherits="Huntable.UI.CustomizeJobsIndustry" %>
                    ...
                    <div class="st_tabs_container st_sliding_active">
                        <div style="overflow: visible;" class="st_slide_container">
                            <ul style="margin-left: 0px;" class="st_tabs">
                                ...
                                <li><a   href="javascript:callnextbutton('customizejobsindustry.aspx');" class="st_tab1 st_first_tab st_tab_active">Industry</a></li>
