<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="aboutus.aspx.cs" Inherits="Huntable.UI.Aboutus" %>
        ...
        <div id="content-inner">
            <div id="tabsAndContent">
                <div id="bx8">
                    <ul id="tabsNav">
                        ...
                        <div runat="server" visible="false">
                            <li><a href="#terms" class="tab-ash">Terms &amp; Conditions</a></li>
                ...
                <ul id="tabContent" style="margin-left: 225px;">
                    <li id="huntable">
                        <div class="welcome-tab" style="font-family: Georgia">
                            <h2 class="heading2 heading2-tab" style="font-family: Georgia">
                                What is Huntable</h2>
                            <div class="huntable-desc" style="font-family: Georgia">
                                <h2>
                                    Huntable is a Professional Resourcing network.</h2>
                                <p style="font-family: Georgia;color: black">
                                    Huntable is all about you, showcasing your professional achievements and finding
                                    the best opportunities, right at your fingertips. It gives you the opportunity to
                                    shine the spotlight on individuals and companies who use this state of the art platform
                                    to present their profile to the world.<br />
                                    <br />
                                    Make sure you’re being noticed by the right people and promoting your specific achievements,
                                    to stand out from the crowd.<br />
                                    <br />
                                    Huntable enables you to get your information in front of the right people, connecting
                                    you with like-minded individuals, industry leaders and company heads from around
                                    the globe.<br />
                                    <br />
                                </p>
                            </div>
                            <div class="huntable-desc">
                                ...
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Are you sending off CVs but not being asked to interview? With many vacancies attracting
                                    dozens of applications, it now takes more than a plain CV and covering letter to
                                    stand out from all other applicants.<br />
                                    <br />
                                    Competition is fierce, but Huntable can help you to get your achievements and profile
                                    noticed by those who really count.<br />
                                    <br />
                                    ...
                                    a new opportunity arises, you will be notified instantly<br />
                                    <br />
                                    <br />
                            ...
                            <div class="huntable-desc" style="font-family: Georgia">
                                ...
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    One of the benefits of using Huntable is that it’s easy to connect with other users,
                                    sharing useful information and identifying the most relevant people in your industry.<br />
                                    <br />
                                    Whether you’re looking to keep up to date with industry trends, or trying to make
                                    contact with a key person in a specific organisation, Huntable offers the fastest
                                    and easiest route to success.<br />
                                    <br />
                                </p>
                            </div>
                            <div class="huntable-desc" style="font-family: Georgia">
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Your time is limited, so you want fast access to the information you need, without
                                    having to wade through pages of pointless updates and conversation streams. You
                                    decide what updates you want to see.<br />
                                    <br />
                                    Choose from a wide range of criteria including skill, industry, user or company.
                                    With Huntable, you’re in control of your information feeds.<br />
                                    <br />
                                </p>
                            ...
                            <div class="huntable-desc" style="font-family: Georgia">
                                ...
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Customising your jobs and feeds has been made exceptionally easy. Job searches are
                                    made faster and more relevant, whilst truly useful information can be accessed in
                                    seconds.<br />
                                    <br />
                                    Huntable has been designed with your needs in mind – so you control what you see.<br />
                                    <br />
                                </p>
                            </div>
                            <div class="huntable-desc" style="font-family: Georgia">
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Make smart use of your marketing budget by registering your company on Huntable.
                                    It’s absolutely free, is easily and quickly uploaded, and your Huntable profile
                                    will prove invaluable in promoting your brand and sharing information with both
                                    your target market and potential employees.<br />
                                    <br />
                                    Interested users will have access to your articles, blog and current vacancies,
                                    saving significant costs for both your marketing and recruitment budgets.<br />
                                    <br />
                                </p>
                            ...
                            <div class="huntable-desc" style="font-family: Georgia">
                                ...
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Our mission is to create a place where everyone can showcase their profile, so companies
                                    and recruiters can find and hire the best matching people without any strings attached.
                                    We want a world where all users can promote, connect, follow and express their views,
                                    without any limitations.<br />
                                    <br />
                                    We want the Huntable application to showcase every person’s professional side.<br />
                                    <br />
                                    - A user should be able to tell the world what they have done and promote their
                                    expertise and skill without any limitation.<br />
                                    <br />
                                    - Companies and recruiters should be able to find, hunt and hire anyone across the
                                    globe within only a few clicks.<br />
                                    <br />
                                </p>
                            </div>
                        </div>
                    ...
                    <li id="faq">
                        <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <li><a href="#" class="menu-ash" >How can I attract followers to my company?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p>
                                                Lorem Lipsum Dummy
                    ...
                    <li id="started">
                        <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <li class="expand"><a href="#" class="menu-ash" style="font-family: Georgia">Why should
                                    you register with Huntable?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Simply because no other professional platform has our power and capabilities. We’ll
                                                help you to keep in touch with whatever is happening in your industry and whoever
                                                has influence and expertise. Showcase your profile to industry leaders and develop
                                                those all-important contacts, right across the world.<br />
                                                <br />
                                                For companies and recruiters, Huntable isn’t just a means of connecting with others
                                                in your industry; it’s a great way to promote your products and services, too.<br />
                                                <br />
                                            </p>
                                        </li>
                                    </ul>
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">Creating your profile?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                As soon as you’ve created your account, simply move to the Edit Profile page, where
                                                you’ll be asked to enter details of your professional background and contact details,
                                                along with the type of job you’re looking for and a photo. You can even save time
                                                by using our automatic Facebook or LinkedIn profile upload tool. It really is as
                                                simple as that. Rest assured your contact details will remain strictly confidential.
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">Customising your feeds<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Having access to the right information is vital in forming those all-important connections,
                                                receiving specific company updates and learning about new trends in the industry.<br />
                                                <br />
                                                Our feeds can be customised by criteria including company and industry to ensure
                                                that your profile always reflects current knowledge, skills and expertise.<br />
                                                <br />
                                            </p>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                ...
                                                which are appropriate for you. Choose to hear about only those jobs, which match
                                                your very specific criteria including salary range, industry, type of job and skills
                                                required.<br />
                                                <br />
                                                Huntable was designed with you in mind.<br />
                                                <br />
                                                Being able to highlight specific skills, knowledge and experience within your profile,
                                                based on industry and company information, will give you the edge in a competitive
                                                market and allow you to present your career achievements in a relevant and timely
                                                way.<br />
                                                <br />
                                            </p>
                                        </li>
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">Adding/Editing your experiences<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                You can add or edit all your experiences in the Edit Profile section. Simply click
                                                Edit, under an experience. This will give you the option to add all the necessary
                                                details about that experience.
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <li><a href="#" class="menu-ash" style="font-family: Georgia">Adding pictures & videos<b>&nbsp;</b></a>
                                        <ul class="acitem">
                                            <li>
                                                <p style="font-family: Georgia;color: black">
                                                    You can add achievements, pictures and video clips to your profile, after adding
                                                    your experience.
                                                </p>
                                            </li>
                                        </ul>
                                    ...
                                    <li>
                                        <li><a href="#" class="menu-ash" style="font-family: Georgia">Deleting a picture, video
                                            or other experiences<b>&nbsp;</b></a>
                                            <ul class="acitem" style="font-family: Georgia;color: black">
                                                <li>
                                                    <p>
                                                        Once you have added a picture or video, you can still delete them from the Edit
                                                        profile in the relevant experience.
                                                    </p>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a href="#" class="menu-ash">How to upload my profile?<b>&nbsp;</b></a>
                                            <ul class="acitem">
                                                <li>
                                                    <p>
                                                        Lorem Lipsum Dummy
                                        ...
                                        <li><a href="#" class="menu-ash">Is my profile available for anyone to see?<b>&nbsp;</b></a>
                                            <ul class="acitem">
                                                <li>
                                                    <p>
                                                        Lorem Lipsum Dummy
                                        ...
                                        <li><a href="#" class="menu-ash" style="font-family: Georgia">Promoting your company
                                            in Huntable<b>&nbsp;</b></a>
                                            <ul class="acitem" style="font-family: Georgia;color: black">
                                                <li>
                                                    <p>
                                                        Make a presence in our community by being active. Post feeds, upload information
                                                        about your products or services, add company pictures and videos or notify everyone
                                                        about your current vacancies.
                                                        <br />
                                                        <br />
                                                        This will draw attention to your online company profile, which in turn will encourage
                                                        followers. You can also promote your company within our featured recruiters section.<br />
                                                        <br />
                                                    </p>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#" class="menu-ash" style="font-family: Georgia">Sending job postings to
                                            relevant job seekers<b>&nbsp;</b></a>
                                            <ul class="acitem" style="font-family: Georgia;color: black">
                                                <li>
                                                    <p>
                                                        Customised jobs is a great feature that we offer for all users who are looking for
                                                        opportunities. Here they can customise jobs by criteria including salary expected,
                                                        their industry, skill, Job type and country of their choice.<br />
                                                        <br />
                                                        When a company post a job matching these criteria, this job will be instantly shown
                                                        in the user’s feeds. This gives maximum exposure to your job.<br />
                                                        <br />
                                        ...
                                        <li><a href="#" class="menu-ash" style="font-family: Georgia">Uploading & updating old
                                            CVs currently in your system<b>&nbsp;</b></a>
                                            <ul class="acitem" style="font-family: Georgia;color: black">
                                                <li>
                                                    <p>
                                                        Huntable offers the most recent, innovative application to recruiters and headhunters.
                                                        This application will enable you to refresh and update all your old and out-dated
                                                        CVs, which you may still retain in your system. It doesn’t matter how old that CV
                                                        is, your candidate database will be updated instantly.<br />
                                                        <br />
                                                        All you need to do is download the free application to your desktop, pointing to
                                                        the folder where your entire database is located. The application will automatically
                                                        add these CVs into your own secure Huntable database.<br />
                                                        <br />
                                                        So if you don’t know what a candidate with an old CV is doing now, your out of date
                                                        record will be automatically updated with their most recent profile, which is also
                                                        searchable.<br />
                                                        <br />
                                                    </p>
                                                </li>
                            ...
                            <div class="huntable-desc" style="border-bottom: none;">
                                ...
                                <div class="contact-main">
                                    <div class="contact-left">
                                        ...
                                        <br />
                                        <label>
                                            Message:</label><textarea class="textarea textbox" cols="1" rows="2" runat="server"
                                                id="txtMessage"></textarea>
                                        <br />
                                        <br />
                                        <label>
                                            &nbsp;</label>
                                        <asp:Button ID="btnSend" runat="server" Text="Send" CssClass="button-orange button-green-upload"
