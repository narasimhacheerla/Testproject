<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="EmployeeActivity.aspx.cs" Inherits="Huntable.UI.EmployeeActivity" %>
        ...
        <div id="content-section">
            <div id="content-inner">
                <div class="accounts-profile2 ">
                    <div class="top-breadcrumb">
                        <div class="accounts-profile2-left">
                            <a href="companieshome.aspx" class="accounts-link">Company</a>&nbsp;&rsaquo;&rsaquo;&nbsp;<a href="#" id="cmpvw" runat="server"
                                ...
                                <div class="tab-container tab1" style="display: block; padding-left: 0px; width: 654px;">
                                    <div class="all-feeds-list">
                                        <div class="general-setting-tab1 general-setting-tab1-overview">
                                            &nbsp;<a href="#" id="bact" runat="server">Business Activity</a> <a href="#"
                                                class="setting-active1">Employee Activity</a>
                                        </div>
                                    </div>
                                   <uc1:UserFeedList ID="UserFeedList1" runat="server" PageType="Employee_Activity" profileUserId="" />
                ...
                <div class="content-inner-right" style="height:1500px">
                    <div class="blue-box-company1" runat="server" id="dvcmp" >
                       ...
                       <asp:Button  OnClientClick="return rowAction01();" class="button-orange button-orange-fc" runat="server" id="Unfollo" OnClick="unfollow_Click" Text="Following" ></asp:Button><br />
                        <br />
                        <br />
                        <asp:Label runat="server" ID="lblcmpny"/> and get upto date info about this company and get their jobs straight into
                        your feeds
