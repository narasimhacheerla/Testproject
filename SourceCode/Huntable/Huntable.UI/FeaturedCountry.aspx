<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FeaturedCountry.aspx.cs" Inherits="Huntable.UI.FeaturedCountry" %>
    ...
    <head>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                if (!msie6) {
                    var top = $('#bx4').offset().top;
                    $(window).scroll(function (event) {
                        var y = $(this).scrollTop();
                        if (y >= 310) { $('#bx4').addClass('fixed'); }
                        else { $('#bx4').removeClass('fixed'); }
                    });
                }
            });</script>
    </head>
            ...
            <div id="content-inner">
                ...
                <div class="content-inner-left">
                    ...
                    <ul class="tab-list tab-list-search">
                        ...
                        <li><a href="featuredcountry.aspx" class="st_tab st_first_tab st_tab_active">Country</a></li>
                    </ul>
                    <div class="company-name-list" style="margin-top: 20px;">
                        ...
                        <div id="Country">
                            ...
                            <asp:DataList ID="dlCountries" runat="server" RepeatColumns="2">
                                <ItemTemplate>
                                    <table>
                                        <tr>
                                            <td>
                ...
                Skills:<asp:Label ID="lblSkills" runat="server" Text="" Visible="true"></asp:Label>
                       ...
                       <%-- <a href="#" class="button-orange" style="float: left; margin-left: 100px;">Continue</a>--%>
                        <asp:Button ID="btnCountry" class="button-orange" style="float: left; margin-left: 100px;" runat="server" Text="Check Out" OnClick="BtnCountryClick" />
                    </div>
                    <p class="margin-top-visible">
                        &nbsp;</p>
                   <div id="bx4"> <uc1:FeaturedRecruiters ID="featuredRec" runat="server" /></div>
                </div>
