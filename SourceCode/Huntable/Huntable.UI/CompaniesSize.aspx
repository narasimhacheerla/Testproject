<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CompaniesSize.aspx.cs" Inherits="Huntable.UI.CompaniesSize" %>
            ...
            <div id="content-inner">
                            ...
                            <div class="st_tabs_container st_sliding_active">
                                <div style="overflow: hidden; margin: 0px 0px 20px 0px;" class="st_slide_container">
                                    <ul style="margin-left: 0px;" class="st_tabs">
                                        ...
                                        <li><a href="companiessize.aspx" class="st_tab st_first_tab st_tab_active">Size</a></li>
                                    ...
                                    <div class="notification-left-top">
                                        <div class="notification-left notification-left-tab ">
                                            <div class="tab-form">
                                                ...
                                                <asp:Repeater runat="server" ID="rspSize">
                                                    <ItemTemplate>
                                                        <asp:CheckBox runat="server" CssClass=" checkbox-tab" ID="chbsize" Text='<%#(Eval("NoofEmployess")) %>' />Employees<br />
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </div>
                                        </div>
                ...
                <div class="content-inner-right" id="bx9">
                    ...
                    <p class="margin-top-visible">
                        &nbsp;</p>
                    <uc1:companiesIntrested runat="server" />
                    <p class="margin-top-visible">
                        &nbsp;</p>
                </div>
            </div>
