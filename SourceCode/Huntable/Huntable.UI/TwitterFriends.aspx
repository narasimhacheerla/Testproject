<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="TwitterFriends.aspx.cs" Inherits="Huntable.UI.TwitterFriends" %>
        ...
        <div id="content-inner">
                            ...
                            <ItemTemplate>
                                <div class="invite-friends-tab" style="width:297px;height:171px;">
                                    ...
                                    <asp:LinkButton ID="lbtnInvite" ToolTip='<%#Eval("UniqueId")%>' OnClick="lbtnInvite_OnClick"
                                        CssClass="invite-friend-btn invite-friend-btn01 " Text="Invite" runat="server"></asp:LinkButton>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
            ...
            <div class="content-inner-right" style="height:885px">
                ...
                <div id="bx28"><div class="box-right">
                    <uc3:Import ID="importContacts" runat="server" />
                </div></div>
            </div>
        </div>
