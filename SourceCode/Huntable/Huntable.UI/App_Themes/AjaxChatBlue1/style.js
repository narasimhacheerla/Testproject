...
function SetMessengerHeight()
{
	if (document.documentElement.clientHeight > 210)
	{
		...
		$get("messages").style.height = document.documentElement.clientHeight - 196 + "px";
		$get("messages").scrollTop = $get("messages").scrollHeight;
	}
	if (document.documentElement.clientWidth > 215)
	{
		$get("am_content-wrap_left").style.width = document.documentElement.clientWidth - 215 + "px";
		$get("am_footer_left").style.width = document.documentElement.clientWidth - 215 + "px";
	}
}