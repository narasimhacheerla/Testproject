function SetHeight()
{
	if (document.documentElement.clientHeight > 256)
	{
		$get("left").style.height = document.documentElement.clientHeight - 152 + "px";
		$get("right").style.height = document.documentElement.clientHeight - 145 + "px";       	
		$get("usersright").style.height = document.documentElement.clientHeight - 256 + "px";
		$get("messages").style.height = document.documentElement.clientHeight - 194 + "px";
		$get("messages").scrollTop = $get("messages").scrollHeight;
	}
	if (document.documentElement.clientWidth > 170)
	{
		$get("left").style.width = document.documentElement.clientWidth - 170 + "px";
