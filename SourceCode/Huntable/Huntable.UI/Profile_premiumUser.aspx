<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Profile_premiumUser.aspx.cs" Inherits="Huntable.UI.Profile_premiumUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <td class="style15">
                <asp:Panel runat="server" ID="panHeader" BackColor="snow" Width="506px">
                    <table class="tableStyle">
                        <tr>
                            <td>
                                <asp:LinkButton runat="server" CssClass="LinkButton" ID="lnkHome" Text="Home" Font-Bold="True"></asp:LinkButton>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:LinkButton runat="server" CssClass="LinkButton" ID="lnkJobs" Text="Jobs" ForeColor="Blue"></asp:LinkButton>
                            </td>
                            <td>
        ...
        <tr>
            ...
            <td valign="top" colspan="2" class="tableStyles1">
                <table cellpadding="0px" cellspacing="0px" class="tableStyle">
                    <tr>
                        ...
                        <td class="columnStyles4">
                            <asp:Button runat="server" ID="btnAdvanced" Text="Advanced" Font-Size="Smaller" />
                        </td>
                    </tr>
                </table>
                ...
                <table class="tableStyle">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:LinkButton ID="LinkButton1" runat="server" Text="...more" CssClass="LinkButton"></asp:LinkButton>
                        </td>
                        <td>
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="image/pdf.png" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <td valign="top">
                <table class="tableStyle">
                    ...
                    <tr>
                        <td>
                            <table style="width: 84%" class="tableStyles1">
                                <tr>
    ...
    <table class="tableStyle">
        ...
        <tr>
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server" BorderColor="#DCDCDC" BorderStyle="Solid" BorderWidth="2px"
                    Width="84%">
                    <asp:Label ID="Label1" runat="server" Width="100%" BackColor="Gainsboro" Text="Invite your friends & Earn money."
        ...
        <tr>
            ...
            <td align="center">
                <asp:ImageButton runat="server" ID="imgSquare" ImageUrl="image/imagesquare.png" /><br />
                <asp:LinkButton runat="server" Text="view more statistics >" CssClass="LinkButton"
