<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="~/CustomizeJobsCountry.aspx.cs" Inherits="Huntable.UI.CustomizeJobsCountry" %>
                            ...
                            <ul style="margin-left: 0px;" class="st_tabs">
                              <li><a  href="javascript:callnextbutton('customizejobssalary.aspx');" class="st_tab1">Salary</a></li>
                               ...
                               <%-- <li><a href="CustomizeJobsCompany.aspx" class="st_tab">Company</a></li>
                                ...
                                <li><a  href="javascript:callnextbutton('customizejobscountry.aspx');" class="st_tab1 st_first_tab st_tab_active">Country</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
