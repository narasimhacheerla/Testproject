<%@ Page Language="C#" MasterPageFile="Admin.Master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="Estream.AjaxChat.Admin.Settings" Title="Settings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphIcon" runat="server">
    <% 
        Master.CrumpsText = Lang.Trans("Settings");
        Master.HeaderText = Lang.Trans("Settings");
        Master.HeaderDescription = Lang.Trans("Here you can customize your website by modifying its settings...");
    %><img src="Images/i_settings.jpg" alt="home" />
</asp:Content>
