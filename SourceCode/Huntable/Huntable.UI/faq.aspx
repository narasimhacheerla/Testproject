<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="Huntable.UI.WebForm1" %>
                 ...
                 <li id="faq">
                        <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <%--<li><a href="#" class="menu-ash" style="font-family: Georgia">What do I Get from Huntable?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Lorem Lipsum Dummy
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How to import my profile?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Lorem Lipsum Dummy
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How to edit my profile?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Lorem Lipsum Dummy
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How to delete my profile?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Lorem Lipsum Dummy
                    ...
                    <li id="started">
                        <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <li class="expand"><a href="#" class="menu-ash" style="font-family: Georgia">Why should you register with Huntable?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
