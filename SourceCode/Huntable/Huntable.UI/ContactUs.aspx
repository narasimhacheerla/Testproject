<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ContactUs.aspx.cs" Inherits="Huntable.UI.ContactUs" %>
                    ...
                    <li id="started">
                        <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <li class="expand"><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Why should you register with Huntable?</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
...
For companies and recruiters, Huntable isn’t just a means of connecting with others in your industry; it’s a great way to promote your products and services, too.
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                      Creating your profile</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                       Customising your feeds</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Customising your jobs</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Adding/Editing your experiences</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                               You can add or edit all your experiences in the Edit Profile section. Simply click Edit, 
                                               under an experience. This will give you the option to add all the necessary details about 
                                               that experience.
                                                <br />
                                                <br />
                                            </p>
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Adding pictures & videos</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Deleting a picture, video or other experiences</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                ...
                                <li><a href="#" class="menu-ash"  style="font-family: Georgia">
                                    <label style="font-size: 14px;">
                                        Promoting your company in Huntable</label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
...
This will draw attention to your online company profile, which in turn will encourage followers.  You can also promote your company within our featured recruiters section.
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia" >
                                    <label style="font-size: 14px;">
                                        Sending job postings to relevant job seekers  </label><b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
...
Whether you’re looking to keep up to date with industry trends, or trying to make contact with a key person in a specific organisation, Huntable offers the fastest and easiest route to success.
                            ...
                            <div class="huntable-desc">
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                   ...
                                   Your time is limited, so you want fast access to the information you need, without having to wade through pages of pointless updates and conversation streams.  You decide what updates you want to see.  
                                   <br />
                                   <br />
Choose from a wide range of criteria including skill, industry, user or company. With Huntable, you’re in control of your information feeds.
                            ...
                            <div class="huntable-desc">
                                ...
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                   ...
                                   Customising your jobs and feeds has been made exceptionally easy. Job searches are made faster and more relevant, whilst truly useful information can be accessed in seconds.  
                                   <br />
                                   <br />
Huntable has been designed with your needs in mind – so you control what you see.
                            ...
                            <div class="huntable-desc">
                                <p class="huntable-desc1" style="font-family: Georgia;color: black">
                                    ...
                                    Make smart use of your marketing budget by registering your company on Huntable.  It’s absolutely free, is easily and quickly uploaded, and your Huntable profile will prove invaluable in promoting your brand and sharing information with both your target market and potential employees.  
                                    <br />
                                    <br />
Interested users will have access to your articles, blog and current vacancies, saving significant costs for both your marketing and recruitment budgets.
...
-	Companies and recruiters should be able to find, hunt and hire anyone across the globe within only a few clicks.
                    ...
                    <div class="welcome-tab">
                            ...
                            <ul class="menu collapsible">
                                ...
                                <li class="expand"><a href="#" class="menu-ash" style="font-family: Georgia">Is my profile available for anyone to see?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                            
                                                Huntable is all about promoting your skills and expertise to the world, so your online
                                                 profile is visible for everyone to view. Anyone can contact you if they find your skills
                                                  and expertise are relevant to them.  Huntable users can also check if you are online and
                                                   chat with you, if you agree to connect. 
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How can Huntable help me?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                If you can be flexible in where you work and have a particular niche skill set or 
                                                experience, then your profile will be made available and highlighted in searches carried 
                                                out by headhunters, internationally.
                                                 <br />
                                                 <br />
                                                Our powerful recruitment functionality, combined with social media compatibility, means
                                                 that for the first time, you can truly tell the world who you are and what you can do.
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">What are the benefits for companies? <b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                By being able to easily view a user’s professional achievements, experience and career to
                                                 date through their up to date profile, companies can analyse an individual much more 
                                                 thoroughly than could be done through a simple CV or application form. 
                                                 <br />
                                                 <br />
                                                By subscribing to your feed, they’ll already be knowledgeable about your products, 
                                                services and up to the minute company news.
                                                <br />
                                                <br />
                                                You can also take advantage of feeds from industry leaders and drivers, who can provide 
                                                innovation, inspiration and insight.
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">Can I advertise my company on Huntable?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Absolutely.  In addition to automatically promoting your products or services throughout
                                                 the world simply by creating a user account, you can also showcase your company on 
                                                 Huntable through advertising or by taking advantage of our free blogging services.
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">If I find a user who interests me, can I contact them?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                Yes, you can contact anyone through the messaging system.  However, for security and 
                                                privacy purposes, we will not reveal any email addresses.
                                                <br />
                                                <br />
                                                ...
                                                we may block their account. 
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How can I attract followers to my company?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                You can encourage users to follow your company by inviting all your present & past 
                                                employees to do so first, using the Find Friends section or in the Company Edit Profile section. 
                                                <br />
                                                <br />
                                                You can also achieve more followers by constantly being active in the community, 
                                                which will encourage other users to follow your company. 
                                            </p>
                                        </li>
                                    </ul>
                                </li>
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How do I headhunt someone in a different part of the world?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                                It doesn’t matter where users are situated.  If they possess the relevant skills and experience, you’ll be able to find them using Huntable’s powerful search functionality.
                                                  Simply enter the relevant criteria in your user search, including country, industry or skill sets.
                                                <br />
                                                <br />
                                            </p>
                                        </li>
                                ...
                                <li><a href="#" class="menu-ash" style="font-family: Georgia">How can I promote my company only to specific users?<b>&nbsp;</b></a>
                                    <ul class="acitem">
                                        <li>
                                            <p style="font-family: Georgia;color: black">
                                               If you’re a company or a recruiter, you can promote your organisation by targeting users 
                                               from a specific industry, skill or country in our Featured Recruiters section.
                                               Your company logo and your job information will be then be displayed to the relevant users.  
