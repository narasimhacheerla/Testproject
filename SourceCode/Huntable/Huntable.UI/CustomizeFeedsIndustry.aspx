<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="CustomizeFeedsIndustry.aspx.cs" Inherits="Huntable.UI.CustomizeFeedsIndustry" %>
        ...
        <div id="content-inner">
            ...
            <div class="content-inner-left">
                <ul class="customize-feed">
                    <li><a href="Customize-User.aspx" class="select" style="border-right: 1px solid #fff;" >Customize Feeds</a></li>
                    <li runat="server" id="jobsal" ><a href="CustomizeJobssalary.aspx" runat="server"  >Customize Jobs</a></li>
                </ul>
                <ul class="tab-list tab-list-search">
                    <li><a  href="javascript:callnextbutton('customize-user.aspx');" class="st_tab">User</a></li>
                    <li><a  href="javascript:callnextbutton('CustomizeFeedsIndustry.aspx');" class="st_tab st_first_tab st_tab_active">Industry</a></li>
                    ...
                    <li><a  href="javascript:callnextbutton('CustomizeFeedscountry.aspx');" class="st_tab">Country</a></li>
                </ul>
                <uc:atoz runat="server" ID="ucAtoZFeedsIndustries" SearchTitle = "Search by Industry:" />                
            </div>
