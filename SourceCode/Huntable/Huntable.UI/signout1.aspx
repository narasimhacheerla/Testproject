<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="signout1.aspx.cs" Inherits="Huntable.UI.signout1" %>
...
<div id="content-section">
 ...
 <div class="sign-out-left"><img width="600" alt="Customize feeds and jobs" title="Customize feeds and jobs" src="images/signout1.jpg" /></div>
   
   <div class="sign-out-right">
   <p class="signout1-font-size1">Customize feeds and jobs</p>
  <p class="signout1-font-size2">Have you customized your</p>
   <ul class="r-list-green">
            	<li>Feeds</li>
                <li>Jobs</li>
                <li>Profile</li>
                <li>Skills</li>
